...
# rewrite /^.*$/ => 'https://en.wikipedia.org/wiki/Leslie_Cannold'

# rewrite /^\/articles\/article\/leslie-wins-2011-humanist-of-the-year-award\// => # '/articles/article/leslie-made-2011-australian-humanist-of-the-year/'
